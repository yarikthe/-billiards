...
<div class="d-flex justify-content-between">
   ...
   Гравць <b class="text-primary">{{ $player->name }}</b>
    ...
    <div class="action">
        <a href="{{ route('admin.destroy',$player->id) }}" class="btn btn-danger"><i class="fa fa-btn fa-trash fa-fw"></i> Видалити</a> 
        <a href="{{ route('admin.edit',$player->id) }}" class="btn btn-light"><i class="fa fa-btn fa-trash fa-fw"></i> Редагувати</a> 
    </div>                        
   </div>
