...
<div class="d-flex justify-content-between">
   ...
   Редагування турніра {{ $edit->name }}
    ...
    <div class="action">
        <a href="/admin/turnir/show/{{ $edit->id }}" class="btn btn-light"><i class="fa fa-btn fa-trash fa-fw"></i> Назад</a> 
    </div>                        
   </div>
   <hr>
                ...
                <div id="accordion">
                            <div class="card">
                                ...
                                <div class="card-body">
                                <form action="/admin/turnir/insert-players" method="POST">
                                @csrf  
            ...
            <form action="{{ route('adminturnir.update',$edit->id) }}" method="POST">
            @csrf  
            <div class="d-flex justify-content-between">
                                ...
                                @if($value->id == $user->player_id)
                                    ...
                                    <div class="d-flex justify-content-between">
                                       <h6 class="m-1 p-2" for="playerID">
                                        ...
                                        <a href="{{ route('adminturnir.remove',$value->id) }}" class="btn btn-danger m-1">Видалити</a>
                                    </div>
                                    <hr>
