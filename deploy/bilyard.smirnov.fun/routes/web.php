...
Route::get('/publicly/turnir/show/{id}', 'PublicController@showTurnir')->name('t.show');
Route::get('/publicly/player/show/{id}', 'PublicController@showPlayer')->name('public.show');
Route::get('/publicly/turnir/table/{id}', 'PublicController@table')->name('public.table');
