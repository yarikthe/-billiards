...
<html lang="en">
  <head>
    ...
    <!-- plugins:css -->
    <link rel="stylesheet" href="{{ asset('public/assets/vendors/iconfonts/mdi/css/materialdesignicons.css')}}">
    <!-- endinject -->
    ...
    <!-- Layout style -->
    <link rel="shortcut icon" href="{{ asset('public/asssets/images/favicon.ico')}}" />
...
<div class="page-body">
      ...
      <div class="sidebar">
        <div class="user-profile">
          <div class="display-avatar animated-avatar">
            <img class="profile-img img-lg rounded-circle" src="/public/uploads/profile/{{Auth::user()->avatar}}" alt="profile image">
          </div>
    ...
    <!-- plugins:js -->
    <script src="{{ asset('public/assets/vendors/js/core.js')}}"></script>
    <!-- endinject -->
    ...
    <script src="{{ asset('public/assets/js/charts/chartjs.addon.js')}}"></script>
    <!-- Vendor Js For This Page Ends-->
    <!-- build:js -->
